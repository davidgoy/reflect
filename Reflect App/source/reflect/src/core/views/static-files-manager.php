  ...
  <div class="container">
      ...
      <div class="col-sm-8">
        ...
        <form id="sfmForm">
          ...
          <div class="form-group">
            ...
            <small id="documentRootHelp" class="form-text text-muted">Also known as web root. On shared hosting, this is commonly <i>public_html</i></small>
          </div>
          ...
          <div class="form-group">
            ...
            <small id="staticFolderNameHelp" class="form-text text-muted">The name of the folder in the document root that will contain pre-generated static files.</small>
          </div>
    ...
    <div class="row">
      ...
      <div class="col">
        ...
        <p class="text-center my-5"><a class="btn btn-secondary" href="//<?php echo $_SERVER['SERVER_NAME']; ?>">HOME</a></p>
