...
<html lang="en">
  ...
  <head>
    ...
    <!-- WordPress -->
    <link rel="stylesheet" href="/css/wordpress/block-library/style.min.css?version=1.0.0-beta.13">
    <link rel="stylesheet" href="/css/wordpress/block-library/theme.min.css?version=1.0.0-beta.13">

    <!-- Underscores -->
    <link rel="stylesheet" href="/css/underscores/style.css?version=1.0.0-beta.13">

    <!-- Bootstrap -->
    <link rel="stylesheet" href="/css/bootstrap/bootstrap.min.css?version=1.0.0-beta.13">
  ...
  <body>
    ...
    <?php if($config['olderBrowsersSupport'] === 'true'): ?>
      ...
      <script src="/js/polyfill/core-js/minified.js?version=1.0.0-beta.13"></script>
      <script src="/js/polyfill/regenerator-runtime/runtime.js?version=1.0.0-beta.13"></script>
      <script src="/js/polyfill/unfetch/index.js?version=1.0.0-beta.13"></script>

    <?php endif; ?>

    <!-- Bootstrap -->
    <script src="/js/bootstrap/jquery-3.5.1.slim.min.js?version=1.0.0-beta.13"></script>
    <script src="/js/bootstrap/bootstrap.bundle.min.js?version=1.0.0-beta.13"></script>

    <!-- SweetAlert2 -->
    <script src="/js/sweetalert2/sweetalert2.all.min.js?version=1.0.0-beta.13"></script>
