...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"PP1H":[function(require,module,exports) {
  ...
  (function reflectStaticFilesManager() {
    ...
    function buildList() {
      ...
      if (params['perPage'] !== undefined) {
        formData.append('perPage', params['perPage']);
      } else {
        formData.append('perPage', sfmListItemsPerPage);
      }
    ...
    function buildPagination() {
      ...
      apiGetData(formData).then(function (response) {
        ...
        var perPage = sfmListItemsPerPage;
        ...
        if (totalLinks > 1) {
          ...
          var listPaginationInfo = document.querySelector('#listPaginationInfo');
          ...
          listPaginationInfo.innerHTML = "Showing ".concat(fromPaginationItem, " - ").concat(toPaginationItem, " of ").concat(totalPublishedItems, " items");
        }
      });
    } //--------------------------------------------------------------------------
