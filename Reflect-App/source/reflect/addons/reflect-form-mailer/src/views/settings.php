        ...
        <div class="row">
          ...
          <div class="col mx-5 px-sm-5">
            ...
            <form id="reflectFormMailerAddonSettings">
              ...
              <div class="row mb-4">
                <label class="form-label" for="slugsToRun">SLUGS TO RUN <small>(OPTIONAL)</small></label>
              ...
              <div class="row mb-4">
                <label class="form-label" for="slugsToExclude">SLUGS TO EXCLUDE <small>(OPTIONAL)</small></label>
              ...
              <div class="row mb-4">
                <label class="form-label" for="formNamesToTarget">FORMS TO TARGET <small>(OPTIONAL)</small></label>
              ...
              <div class="row mb-4">
                <label class="form-label" for="formNamesToExclude">FORMS TO EXCLUDE <small>(OPTIONAL)</small></label>
              ...
              <div class="row mb-4">
                <label class="form-label" for="recipientName"><i>TO</i> NAME</label>
              ...
              <div class="row mb-4">
                <label class="form-label" for="recipientEmailAddress"><i>TO</i> EMAIL ADDRESS</label>
              ...
              <div class="row mb-4">
                <label class="form-label" for="fromName"><i>FROM</i> NAME</label>
              ...
              <div class="row mb-4">
                <label class="form-label" for="fromEmailAddress"><i>FROM</i> EMAIL ADDRESS</label>
