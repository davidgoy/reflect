        ...
        <div class="row">
          ...
          <div class="col">
            ...
            <form id="defaultThemeSettings">
              ...
              <div class="row mb-4">
                <label class="form-label" for="faviconUrl">FAVICON URL <small>(OPTIONAL)</small></label>
              ...
              <div class="row mb-4">
                <label class="form-label" for="logoUrl">LOGO URL <small>(OPTIONAL)</small></label>
              ...
              <div class="row mb-4">
                <label class="form-label" for="mainContentSidePadding">MAIN CONTENT SIDE PADDING</label>
              ...
              <div class="row mb-4">
                <label class="form-label mb-3">PRIMARY MENU COLOUR</label>
                <div class="row mb-3">
                  <div class="col">
              ...
              <div class="row mt-5">
                <label class="form-label mb-3">FOOTER MENU COLOUR</label>
                <div class="row mb-3">
                  <div class="col">
              ...
              <div class="row mb-4">
                <label class="form-label" for="homePageTitleDisplayOption">HOME PAGE</label>
              ...
              <div class="row mb-4">
                <label class="form-label" for="postsPageTitleDisplayOption">POSTS PAGE</label>
              ...
              <div class="row mb-4">
                <label class="form-label" for="pageTitleDisplayOption">PAGES</label>
              ...
              <div class="row mb-4">
                <label class="form-label" for="postTitleDisplayOption">POSTS</label>
