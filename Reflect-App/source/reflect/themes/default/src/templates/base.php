...
<html lang="en">
  ...
  <head>
    ...
    <!-- WordPress -->
    <link rel="stylesheet" href="/css/wordpress/block-library/style.min.css?version=1.0.0-beta.12">
    <link rel="stylesheet" href="/css/wordpress/block-library/theme.min.css?version=1.0.0-beta.12">

    <!-- Underscores -->
    <link rel="stylesheet" href="/css/underscores/style.css?version=1.0.0-beta.12">
  ...
  <body>
    ...
    <?php if($config['olderBrowsersSupport'] === 'true'): ?>
      ...
      <script src="/js/polyfill/core-js/minified.js?version=1.0.0-beta.12"></script>
      <script src="/js/polyfill/regenerator-runtime/runtime.js?version=1.0.0-beta.12"></script>
      <script src="/js/polyfill/unfetch/index.js?version=1.0.0-beta.12"></script>
